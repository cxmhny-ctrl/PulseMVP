...
export default function StuckMode() {
  ...
  return (
    <div className="max-w-lg mx-auto animate-fade-in">
      {/* Ambient depth background for Stuck Mode */}
      <div className="pointer-events-none fixed inset-0 bg-depth/60 z-0" />

      <div className="relative z-10">
        {/* Task context */}
        <div className="mb-4">
          <p className="text-xs uppercase tracking-[0.2em] text-depth-border mb-2">
            Stuck on
          </p>
        ...
        {/* Stuck path indicator */}
        <div className="mb-8 flex justify-center">
          <StuckPath
            currentStage={
              stage === "done" ? "started" : stage === "result" ? "step" : "stuck"
            }
          />
        </div>
        ...
        {stage === "intake" && (
          <div className="surface-depth-card space-y-5">
            <p className="text-sm font-medium text-white">
              What feels stuck?
            </p>
            <textarea
              className="w-full rounded-xl border border-depth-border bg-depth px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:border-sage/30 focus:outline-none focus:ring-0 resize-none"
              rows={2}
        ...
        {stage === "generating" && (
          <div className="surface-depth-card py-10">
        ...
        {stage === "result" && step && (
          <div className="surface-depth-card space-y-6">
            {/* Next step */}
            ...
            <div className="flex items-center justify-center gap-3 text-xs text-gray-400">
              ...
              {step.frictionType && (
                <>
                  <span className="text-depth-border">&middot;</span>
            ...
            {!showEasier && (
              <div className="space-y-2">
                ...
                <button
                  ...
                  className="w-full py-2 text-xs text-gray-400 hover:text-gray-300 transition-colors duration-200"
                >
                  Not now
                </button>
              </div>
        ...
        {stage === "done" && (
          <div className="surface-depth-card space-y-5 text-center">
