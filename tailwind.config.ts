  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "orb-expand":   "orbExpand 3.2s cubic-bezier(0.32,0.72,0,1) infinite",
        "orb-expand-slow": "orbExpandSlow 3.2s cubic-bezier(0.32,0.72,0,1) 1.6s infinite",
      },
      keyframes: {
        ...
        orbExpand:      { "0%": { transform: "scale(1)", opacity: "0.18" }, "100%": { transform: "scale(2.8)", opacity: "0" } },
        orbExpandSlow:  { "0%": { transform: "scale(1)", opacity: "0.10" }, "100%": { transform: "scale(3.6)", opacity: "0" } },
      },
    },
  },
  plugins: [],
